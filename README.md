...
[![MCP Tools](https://img.shields.io/badge/MCP_tools-132-58a6ff.svg)](https://github.com/VibOpsai/vibops-mcp)
...
`vibops-mcp` is a single MCP server that abstracts this complexity. One `pip install`, 132 tools, and your AI assistant can observe, operate, govern, and optimize your entire GPU fleet — regardless of where it runs.
