...
async def test_get_budget():
    ...
    mock.assert_called_once_with("/api/v1/finops/budget")
...
async def test_get_chargeback():
    ...
    mock.assert_called_once_with("/api/v1/finops/chargeback/2026/5")
...
async def test_get_spend_trend_default():
    ...
    mock.assert_called_once_with("/api/v1/finops/spend/trend", params={"days": 30})
...
async def test_get_spend_trend_custom_days():
    ...
    mock.assert_called_once_with("/api/v1/finops/spend/trend", params={"days": 7})
...
async def test_get_waste_analysis():
    ...
    mock.assert_called_once_with("/api/v1/finops/waste")
