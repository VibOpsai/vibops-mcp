...
mcp.tool()(observation.get_vm_usage)
...
# VM / Hypervisor (Proxmox + Xen Orchestra)
mcp.tool()(actions.proxmox_list_vms)
mcp.tool()(actions.proxmox_start_vm)
mcp.tool()(actions.proxmox_stop_vm)
mcp.tool()(actions.proxmox_migrate_vm)
mcp.tool()(actions.proxmox_create_snapshot)
mcp.tool()(actions.xo_list_vms)
mcp.tool()(actions.xo_start_vm)
mcp.tool()(actions.xo_stop_vm)
